...
data \citep[for example,][]{pdc1, pdc2, arc, dun} and ground-based surveys
\citep[for example,][]{hat} but they have yet to be generalized to \KT.
...
acknowledging this will cause us to miss some planets \citep{SanchisOjeda14}.
...
realistic light curve model \citep{ma, kipping-ld}.
