...
We apply this method to the full Campaign~1 dataset and report a list of 38
planet candidates transiting 33 stars.
...
We also present a list of \dfmtodo{ZZZZ} candidate eclipsing binary systems.
...
orbiting 33 stars---and a supplementary list of \dfmtodo{YYYY} eclipsing binary
...
Two (\dfmtodo{give names here})
were previously published \citep{Crossfield:2015} but, to our knowledge,
the remaining list is currently unpublished.
...
\dfmtodo{Didn't Charbonneau show some K2 planet at NYU?  Is that in our list and does it need to be mentioned or discussed?  Also, what about the planet we were shown by Vandenburg, private communication?}

(Note: C1 data came out the week between Christmas and New Years, so Charbonneau 
didn't show anything from C1. Based on when he came down to visit you guys, it was
very likely Andrew's HIP 116454 he showed).
...
Figure~\dfmtodo{SOMEFIGURE} shows the observed distribution of planet candidates in our
catalog.
...
This function is shown in Figure \dfmtodo{SOMEFIGURE and IS THIS CONSISTENT INTERESTING ETC?}
