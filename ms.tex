...
detected from the ground.  We note that while \citet{Santerne:2012} reported
a $\sim$35\% observational false positive rate, that study was exclusively 
focused on short-period, large candidates, among which false positives
are expected to be more likely.  \citet{Desert:2015} has observationally confirmed 
a low false positive rate for the majority of \kepler\ candidate parameter
space.
